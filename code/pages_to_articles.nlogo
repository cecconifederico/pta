...
undirected-link-breed [pagtoarts pagetoart]
...
globals [articles_db pages_db websites_db users_db actual_page_list actual_article_pool actual_article_web_pool issue_w intensity_w political_direction]
...
to run_simulation
  ...
  foreach actual_article_web_pool [the-article ->
    ...
    if (item 1 the-article) > (random-float 1) [
      ...
      ask actual_page [
        create-pagetoart-with (item 0 the-article) [set color red]
      ]
    ]
  ]
 tick
